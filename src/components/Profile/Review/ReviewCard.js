...
export default function ReviewCard({ review, sb }) {
    ...
    return (
        <div className="group bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-md p-6 shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-300 ease-out">
            ...
            <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-purple-500/5 rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 -m-2 p-2" />
