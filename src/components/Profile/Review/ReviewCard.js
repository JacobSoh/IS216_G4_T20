        ...
        <div className="group bg-[var(--theme-surface)] border border-[var(--theme-border)] rounded-md p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ease-out">
            <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="font-bold text-[var(--theme-surface-contrast)] text-lg">
                            {reviewerName}
                        </div>
            ...
            <div className="relative">
                <p className="relative text-[var(--theme-surface-contrast)] text-base leading-relaxed pl-3 border-l-4 border-transparent">
