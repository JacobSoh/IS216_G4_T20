...
const ItemWonCard = ({ iid, title, description, final_price, sold_at, picUrl }) => {
  ...
  return (
    <div className="group bg-white rounded-lg overflow-hidden border border-gray-200 hover:border-green-500 transition-all duration-300 hover:shadow-lg flex flex-col h-full">
      {/* Image */}
