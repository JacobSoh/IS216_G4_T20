...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        defaultClassNames.day,
        "transition-colors duration-150 hover:bg-[var(--theme-secondary)]/20 hover:text-[var(--theme-surface-contrast)]",
        "data-[selected-single=true]:bg-[var(--theme-primary)] data-[selected-single=true]:text-[var(--theme-cream)]",
        "data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground",
        "data-[range-start=true]:bg-[var(--theme-primary)] data-[range-start=true]:text-[var(--theme-cream)]",
        "data-[range-end=true]:bg-[var(--theme-primary)] data-[range-end=true]:text-[var(--theme-cream)]",
