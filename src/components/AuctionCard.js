...
const AuctionCard = ({
  ...
  <div className="group bg-[#13202e] rounded-lg overflow-hidden border border-[#154D71] hover:border-[#49aee9] transition-all duration-300 hover:shadow-lg flex flex-col h-full">
    {/* Image */}
