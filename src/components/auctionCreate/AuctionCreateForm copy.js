...
import AddItemModal from './AddItemModal - c';
      ...
      <form className="w-full min-h-screen p-10 flex flex-col justify-center items-center bg-[var(--custom-bg-primary)]" style={{ color: 'var(--custom-text-primary)' }}>
        ...
        <div className="w-full max-w-4xl grid grid-cols-2 gap-8 mb-10">
          <div className="flex flex-col gap-6 justify-start">
            ...
            <div>
              ...
              <textarea
                className="block w-full rounded-md p-4 min-h-[70px] bg-[var(--custom-bg-secondary)] border-b-2 border-[var(--custom-border-color)] text-[var(--custom-text-primary)] resize-none focus:outline-none focus:border-[var(--custom-bright-blue)]"
          ...
          <div className="flex flex-col justify-start items-center">
            ...
            <div
              className="w-full h-56 rounded-md border-2 border-dashed border-[var(--custom-bright-blue)] bg-[var(--custom-bg-secondary)] flex flex-col items-center justify-center cursor-pointer hover:bg-[var(--custom-bg-tertiary)] transition group relative"
        ...
        <div className="w-full max-w-4xl mt-10">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              type="button"
              className="bg-[var(--custom-bright-blue)] text-white px-5 py-2 rounded-full font-bold hover:bg-[var(--custom-bright-blue)]/70 transition"
              onClick={() => setModalOpen(false) || setModalOpen(true)}
            >
              + Create Item
            </button>
          </div>
          <div className="flex flex-col gap-4">
            {items.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="relative group flex gap-6 bg-[var(--custom-bg-secondary)] rounded-md shadow p-5 mb-2 items-center transition"
                >
                  {/* Center overlay with dim on hover */}
                  <div className="absolute inset-0 bg-black/40 rounded-md flex items-center justify-center z-10 opacity-0 group-hover:opacity-100 transition">
                    <div className="flex gap-6">
                      <button
                        className="flex items-center gap-2 px-4 py-3 bg-[var(--custom-ocean-blue)] text-white rounded-md shadow hover:bg-[var(--custom-cream-yellow)] hover:text-[var(--custom-ocean-blue)] font-semibold text-base transition"
                      ...
                      <button
                        className="flex items-center gap-2 px-4 py-3 bg-[var(--custom-accent-red)] text-white rounded-md shadow hover:bg-[var(--custom-cream-yellow)] hover:text-[var(--custom-accent-red)] font-semibold text-base transition"
                  ...
                  <div className="flex-shrink-0 w-[160px] h-[100px] rounded-md overflow-hidden border border-[var(--custom-ocean-blue)] p-0 m-0 flex items-center justify-center bg-black/10">
