    ...
    <div className={`flex flex-col ${alignment} w-full max-w-[600px] relative group`}>
      ...
      <div className="relative w-full h-[400px] overflow-hidden rounded-md">
        {picUrl ? (
          ...
          <div className="w-full h-full bg-purple-500/10 flex items-center justify-center text-purple-400 rounded-md">
            No Image
          </div>
        )}
      </div>
...
export const AuctionMinimalSkeleton = () => {
  return (
    <div className="flex flex-col items-center w-full max-w-[600px] animate-pulse">
      <div className="w-full h-[400px] rounded-md bg-purple-500/10 overflow-hidden" />
      <div className="h-8" />
...
export const AuctionHoverPictureSkeleton = () => {
  return (
    <div className="flex flex-col w-full max-w-[500px] animate-pulse">
      <div className="w-full h-[300px] rounded-md bg-purple-500/10" />
      <div className="h-4" />
