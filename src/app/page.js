...
//   // Show login modal when redirected with login flag
//   useEffect(() => {
...
//       setModalHeader({ title: 'Login', description: 'Please sign in to continue.' });
//       setModalForm({
//         isForm: true,
//         onSubmit: async (e) => {
//           e.preventDefault();
...
//       // Remove the login flag so it doesn't retrigger
...
//       }
//     }
//   }, [searchParams, setModalHeader, setModalState, setModalForm, router]);
...
//         className="fixed top-[12px] left-[12px] right-[12px] bottom-[12px] border-2 border-purple-500 pointer-events-none z-[1000] shadow-[0_0_20px_rgba(168,85,247,0.6),inset_0_0_20px_rgba(168,85,247,0.3)] rounded-md"
//       />
//       {/* Glow background */}
//       <motion.div
//         animate={{ opacity: showFrame ? 1 : 0 }}
...
//           <div className="sticky top-20 w-[400px] h-[300px] mr-8 border-2 border-dashed border-purple-700/40 flex items-center justify-center text-purple-700/60 rounded-md shadow-lg">
//             Image Placeholder
//           </div>
//         </div>
//       </section>
...
//       className={`px-16 py-6 text-2xl rounded-md border-4 transition-all duration-300 ${
//         auctionClicks >= 3
...
//             ].map((q, i) => (
//               <AccordionItem key={i} value={`item-${i}`} className="border border-purple-400/40 rounded-md">
