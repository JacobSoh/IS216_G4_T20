    ...
    <section className="min-h-screen relative pt-10 bg-gradient-to-b from-[#fff5e1] to-[#ffefea]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {members.map((m, i) => (
            <div key={i} className="bg-white p-6 rounded-md shadow hover:shadow-lg transition flex flex-col items-center text-center">
        ...
        {/* Enquiry Form */}
        <div className="w-full sm:w-[calc(100%+1.5rem)] md:w-[calc(100%+3rem)] lg:w-[calc(100%+4.5rem)] max-w-[1600px] mx-auto bg-white p-8 rounded-md shadow-md">
